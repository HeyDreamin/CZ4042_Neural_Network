...
def plots(opt):
	...
	plt.title('training cost with hnno='+opt)
	...
	plt.title('test accuracy with hnno='+opt)
...
def timeplot(opt):
	...
	plt.ylabel('Time')
	plt.title('Update time with No of HN')
	plt.savefig('p1a_HN_time.png')
...
for hnno in hnnoA:
	...
	test_accuracy = []
	train_cost = []
	print('No. of hidden neurons = %d running'%hnno)
